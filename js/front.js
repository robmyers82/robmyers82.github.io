...
function contactForm() {
	...
	$.ajax({
	    ...
	    success: function (data)
	    {
			...
			var alertBox = '<div class="alert alert-success alert-dismissable animated bounceIn"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Thanks for your e-mail, I will get back to you shortly!</div>';
